...
public class SNMPExceptions extends Exception{
    ...
    public static final String MSG_USR_DEBE_SELECCIONAR_EXCEL = "DAO.exception.DEBE.SELECCIONAR_EXCEL";
    public static final String MSG_USR_DATASOURCE_EXCEPTION = "DAO.exception.ERROR.DATASOURCE";
    public static final String MSG_USR_MISE = "DAO.exception.MISE_EXCEPTION";
    ...
    /**
     * Constructor que se encara de asignar el valor del tipo de exception, el
     * mensaje para el usuario y el mensaje para imprimir en consola para el
     * desarrollador
     *
    ...
    /**
     * Constructor que ádemas recibe el código del error de la exception para
     * inmprimirlo en la consola para el desarrollador aplica para SQLException
     *
     * @param pvnTipoException
     * @param pvcMensaje
    ...
    /**
     * Constructor que ádemas recibe la base de datos en la que se origino la
     * exception para imprimir un mesaje personalizado de acuerdo al código de
     * error, aplica para SQLException
     *
     * @param pvnTipoException
     * @param pvcMensaje
     * @param pvnCodigoError
